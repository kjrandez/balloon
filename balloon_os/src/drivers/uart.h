...
*
* @note		C-Style signature:
*		uint32_t XUartPs_IsTransmitFifoEmpty(uint32_t BaseAddress)
*
******************************************************************************/
...
*
* @note		C-Style signature:
*		uint32_t XUartPs_IsTransmitActive(uint32_t BaseAddress)
*
******************************************************************************/
...
void XUartPs_ResetHw(uint32_t BaseAddress);

void XUartPs_WaitTransmitDone(uint32_t BaseAddress);
